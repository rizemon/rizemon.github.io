...
The Discord bot has access to 3 different text channels, one of which seemed to might hold the flag. To view their contents, the script is modified to print the message history of all 3 channels:
